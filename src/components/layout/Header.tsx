  ...
  return (
    <ScrollHeader>
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 lg:px-8">
        <Link href={homeHref} className="relative z-10 flex shrink-0 items-center">
          <Image
            src="/images/brand/logo-dongfang.png"
            alt={dict.site.name}
            width={240}
            height={108}
            className="h-14 w-auto rounded bg-white px-2 py-1 object-contain shadow-sm sm:h-16 lg:h-[4.75rem]"
            priority
            unoptimized
          />
        </Link>
